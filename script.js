...
/* Level: string plan to array of arrays */
class Level {
  constructor(plan) {
...
/* State: track a the state of running games */
/* LEVEL, ACTORS, STATUS */
class State {
...
/* DRAWING */
// create an element, gives it attributes, and child nodes
function elt(name, atts, ...children) {
    let dom = document.createElement(name);
    for (let att of Object.keys(atts)) dom.setAttribute(att, atts[att]);
    for (let child of children) dom.appendChild(child);
    return dom;
}

// @TESTING
// console.log(elt("td", {class: "hate"}, []));

// creating a display: using a parent element, and level object.
class DOMDisplay {
